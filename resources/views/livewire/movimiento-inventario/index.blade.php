<div class="container py-2">
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white fw-bold">
            <i class="bi bi-arrow-left-right me-2"></i>Movimiento de Inventario
        </div>
            ...
            <form wire:submit.prevent="realizarMovimiento" class="row g-3" wire:click.outside="cerrarResultados">
                ...
                <div class="col-12 position-relative">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text"
                               wire:model.live="searchConsumible"
                               class="form-control"
                               placeholder="Escriba el nombre del consumible..."
                               autocomplete="off">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    @if ($origen_tipo === 'cliente')
                        ...
                        <div class="position-relative">
                            <div class="input-group">
                                ...
                                <input type="text"
                                       wire:model.live="searchClienteOrigen"
                                       class="form-control"
                    ...
                    @else
                        <select wire:model="origen_id" class="form-select" 
                                {{ empty($origenes) ? 'disabled' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    @if ($destino_tipo === 'cliente')
                        ...
                        <div class="position-relative">
                            <div class="input-group">
                                ...
                                <input type="text"
                                       wire:model.live="searchClienteDestino"
                                       class="form-control"
                                       placeholder="Buscar cliente..."
                                       autocomplete="off">
                            </div>
                    ...
                    @else
                        <select wire:model="destino_id" class="form-select"
                                {{ empty($destinos) ? 'disabled' : '' }}>
