            ...
            <div class="p-2 border-bottom bg-white flex-shrink-0">
                <div class="input-group">
                    ...
                    <input 
                        ...
                        wire:keyup="buscarConversaciones"
                    >
                </div>
            </div>
        ...
        <div class="col-12 col-md-8 col-lg-9 d-flex flex-column p-0 bg-light" style="height: 100%;">
            ...
            @if($conversacionActiva)
                @php
                    ...
                    $estadoTexto = $conversacionActiva->estado == 'abierto' ? 'En línea' : ($conversacionActiva->estado == 'cerrado' ? 'Desconectado' : 'Conectado');
                @endphp
                ...
                <div class="bg-white p-3 d-flex align-items-center border-bottom flex-shrink-0">
                    ...
                    <div style="min-width: 0;">
                        <div class="fw-bold text-truncate">{{ $nombreActivo }}</div>
                ...
                <!-- Mensajes - con scroll -->
                <div class="flex-grow-1 p-3 overflow-auto" id="messageArea" style="background: #f8f9fa; overflow-y: auto;">
                    ...
                    @forelse($mensajes as $mensaje)
                        ...
                        @if(isset($fechaMostrar))
                            <div class="text-center mb-3">
                                <span class="bg-white px-3 py-1 rounded-pill small text-muted shadow-sm">{{ $fechaMostrar }}</span>
                            </div>
                        ...
                        <div class="d-flex {{ $mensaje->tipo == 'cliente' ? '' : 'justify-content-end' }} mb-2">
                            <div class="p-2 rounded-3 shadow-sm {{ $mensaje->tipo == 'cliente' ? 'bg-white' : 'bg-success text-white' }}" 
                                ...
                                <div class="text-end mt-1">
                                    <small style="font-size: 0.65rem; {{ $mensaje->tipo == 'cliente' ? 'color: #6c757d;' : 'opacity: 0.8;' }}">
