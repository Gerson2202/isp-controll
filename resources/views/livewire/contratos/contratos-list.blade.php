<div>
    <div class="container-fluid min-vh-100 d-flex flex-column">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Buscar por cliente, tecnología o estado..."
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-3">
                <select class="form-select" wire:model.live="filterTecnologia">
            ...
            <div class="col-md-3">
                <select class="form-select" wire:model.live="filterNodo">
                    <option value="">Nodo</option>
                    @foreach ($estadisticasNodos as $nodo)
                        <option value="{{ $nodo->id }}">{{ $nodo->nodo_nombre }}</option>
                    @endforeach
                </select>
            </div>

            <div class="col-md-3">
                <select class="form-select" wire:model.live="filterEstadoCliente">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            <strong>Total registros: {{ $totalFiltrados }}</strong>
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-primary text-white" data-bs-toggle="collapse" href="#estadisticasNodoCollapse"
                role="button" aria-expanded="false" aria-controls="estadisticasNodoCollapse" style="cursor: pointer;">
                <h5 class="mb-0 d-flex justify-content-between align-items-center">
                    Estadísticas por Nodo
                    <i class="fas fa-chevron-down"></i>
                </h5>
            </div>
            <div class="collapse" id="estadisticasNodoCollapse">
                            ...
                            <tbody>
                                @foreach ($estadisticasNodos as $estadistica)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ number_format($estadistica->total_clientes, 0) }}
                                        </td>
                        ...
                        <tbody>
                            @foreach ($contratos as $contrato)
                                <tr>
                                    ...
                                    <td>{{ $contrato->fecha_fin ? date('d/m/Y', strtotime($contrato->fecha_fin)) : 'N/A' }}
                                    </td>
                                    <td>
                                        <span
                                            class="badge bg-{{ $contrato->estado === 'activo' ? 'success' : ($contrato->estado === 'cancelado' ? 'danger' : 'warning') }}">
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $contrato->cliente->estado === 'activo' ? 'success' : 'danger' }}">
        ...
        <!-- Modal de edición -->
        <div wire:ignore.self class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="modalClienteLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">Editar Contrato #{{ $contratoId ?? '' }}</h5>
                        <button wire:click="hide" type="button" class="btn-close" data-bs-dismiss="modal"
                        ...
                        <form wire:submit.prevent="updateContrato">
                            <div class="row g-3">
                                    ...
                                    <select class="form-select" wire:model="cliente_id" disabled>
                                        ...
                                        @foreach ($clientes as $cliente)
                                            <option value="{{ $cliente->id }}"
                                                {{ $cliente->id == $cliente_id ? 'selected' : '' }}>
                                                {{ $cliente->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" wire:model="estado" required>
                                        ...
                                        <option value="cancelado" {{ $estado == 'cancelado' ? 'selected' : '' }}>
                                            cancelado</option>
                                        <option value="suspendido" {{ $estado == 'suspendido' ? 'selected' : '' }}>
                                            Suspendido</option>
                                    </select>
                                    <small class="text-danger">Los estados diferente de <strong>activo</strong> no se
                                        tendran en cuenta para facturacion.</small>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="precio" required>
                                    </div>
                            ...
                            <div class="modal-footer mt-4">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    <span wire:loading wire:target="updateContrato"
