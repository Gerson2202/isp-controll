                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Mes">
                                            @php
                                                ...
                                                $mesNumero = $factura->fecha_emision
                                                    ? date('n', strtotime($factura->fecha_emision))
                                                    : null;
                                    ...
                                    <form wire:submit.prevent="registrarPago">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" wire:model="monto" class="form-control" step="0.01"
                                                min="0.01" max="{{ $facturaSeleccionada->saldo_pendiente }}">
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-gradient-success text-white">
                                    ...
                                    <button type="button" class="btn-close btn-close-white" aria-label="Close"
                                        wire:click="cerrarComprobante"></button>
                                </div>
                                    ...
                                    <div class="row g-3">
                                            ...
                                            <div class="card border-0 shadow-sm h-100">
                                                <div class="card-header bg-light">
                                                    <h6 class="mb-0 fw-bold">
                                                        <i class="fas fa-user-tie me-2 text-primary"></i> INFORMACIÓN
                                                        DEL CLIENTE
                                                    </h6>
                                                </div>
                                                <div class="card-body">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><strong>Nombre:</strong>
                                                            {{ $facturaSeleccionada->contrato->cliente->nombre }}</li>
                                                        <li class="mb-2"><strong>Identificación:</strong>
                                                            {{ $facturaSeleccionada->contrato->cliente->cedula }}</li>
                                                        <li class="mb-2"><strong>Contacto:</strong>
                                                            {{ $facturaSeleccionada->contrato->cliente->telefono }}
                                                        </li>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border-0 shadow-sm h-100">
                                                <div class="card-header bg-light">
                                                    <h6 class="mb-0 fw-bold">
                                                        <i class="fas fa-receipt me-2 text-primary"></i> DETALLES DE
                                                        PAGO
                                                    </h6>
                                                </div>
                                                <div class="card-body">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="mb-2"><strong>Fecha de pago:</strong>
                                                            {{ date('d/m/Y', strtotime($pagoRegistrado->fecha_pago)) }}
                                                        </li>
                                                        <li class="mb-2">
                                                            <strong>Periodo del servicio:</strong>
                                                            {{ \Carbon\Carbon::parse($pagoRegistrado->factura->fecha_emision)->locale('es')->translatedFormat('F Y') }}
                                                        </li>

                                                        <li class="mb-2"><strong>Método:</strong> <span
                                                                class="badge bg-success">{{ ucfirst($pagoRegistrado->metodo_pago) }}</span>
                                                        </li>
                                                        <li class="mb-2"><strong>Monto:</strong> <span
                                                                class="fw-bold">${{ number_format($pagoRegistrado->monto, 2) }}</span>
                                                        </li>
                                                        <li class="mb-2"><strong>Saldo pendiente :</strong> <span
                                                                class="fw-bold">${{ number_format($facturaSeleccionada->saldo_pendiente, 2) }}</span>
                                                        </li>
                                                        <li class="mb-2"><strong>Comprobante:</strong>
                                                            {{ $facturaSeleccionada->numero_factura }}</li>
                                                        <li><strong>Estado:</strong> <span
                                                                class="badge bg-success">{{ $facturaSeleccionada->estado }}</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    @if ($facturaSeleccionada->contrato->cliente->telefono)
                                        @php
                                            ...
                                            $mensaje .=
                                                "Adjunto encontrarás el *comprobante de pago* de tu servicio de internet.\n\n";
                                            $mensaje .=
