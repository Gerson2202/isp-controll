                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="form-control-plaintext">
                                        {{ $cliente->contrato->plan->nodo->nombre ?? 'sin nodo' }}</p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <form wire:submit.prevent="actualizarContrato">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="node" class="form-select" wire:model="selectedNodeId"
                                        wire:change="changeNode" required>
                                    ...
                                    <select id="plan_id" class="form-select" wire:model="plan_id" required>
                                        ...
                                        @foreach ($planes as $plan)
                                            <option value="{{ $plan->id }}"
                                                {{ $plan->contratos_count >= 50 ? 'disabled' : '' }}
                                                @selected($plan->id == $cliente->contrato->plan_id)>
                                                {{ $plan->nombre }} ({{ $plan->contratos_count }}/50)
                                                @if ($plan->contratos_count >= 50)
                                                    - FULL
                                                @endif
                                            </option>
                                        @endforeach
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control @error('precio') is-invalid @enderror"
                                        wire:model="precio" min="0" required>
                                    @error('precio')
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <button type="submit" class="btn btn-primary me-md-2" wire:loading.attr="disabled">
