        ...
        <div class="card">
            <div class="card-header">
                ...
                @if (!$cliente->ip)
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Atención:</strong> Este cliente no tiene IP asignada. No se pueden realizar cambios ni
                        suspensiones en MikroTik.
                    </div>
                @endif
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs card-header-tabs" id="clienteTabs" role="tablist">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" id="equipos-tab" data-toggle="tab" href="#equipos" role="tab">Ver Equipos
                            Asignados</a>
                    </li> --}}
                    <li class="nav-item">
                        <a class="nav-link" id="nueva-pestana-tab" data-toggle="pill" href="#nueva-pestana"
                            role="tab">Modificar estado</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="modificar-plan-tab" data-toggle="pill" href="#modificar-plan"
                            role="tab">Modificar Plan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="modificar-nodo-tab" data-toggle="pill" href="#modificar-nodo"
                            role="tab">Cambiar de Nodo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="facturas-tab" data-toggle="pill" href="#facturas" role="tab">Estado de
                            Factura</a>
                    </li>
                    {{-- <li class="nav-item">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div>
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="text-secondary"><i class="far fa-fw fa-file-word"></i><strong>
                                                Cedula:</strong> {{ $cliente->cedula }}</li>
                                        <li class="text-secondary"><i class="far fa-fw fa-file-word"></i><strong>
                                                Telefono:</strong> {{ $cliente->telefono }}</li>
                                        <li class="text-secondary"><i class="far fa-fw fa-envelope"></i><strong>
                                                Correo:</strong> {{ $cliente->correo }}</li>
                                        <li class="text-secondary"><i class="far fa-fw fa-image"></i><strong>
                                                Direccion:</strong> {{ $cliente->direccion }}</li>
                                        ...
                                        <li class=" text-secondary"><i class="far fa-calendar-alt fa-fw"></i><strong>
                                                Fecha de registro:</strong> {{ $cliente->created_at }}</li>
                                    </ul>

                                    <!-- Modal de Edición -->
                                    <div class="modal fade" id="editClienteModal" tabindex="-1"
                                        aria-labelledby="editClienteModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editClienteModalLabel">Editar Información
                                                        del Cliente</h5>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        ...
                                                                        value="{{ $cliente->latitud }}" min="-90"
                                                                        max="90" step="0.000001"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        ...
                                                                        value="{{ $cliente->longitud }}" min="-180"
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            @else
                                                <li
                                                    ...
                                                    <span
                                                        class="badge bg-primary bg-opacity-10 text-dark">{{ $cliente->contrato->plan->nodo->nombre }}</span>
                                                </li>
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center">
                                                    <span>
                                                    ...
                                                    <a href="{{ $urlPrivada }}" target="_blank"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="info-box bg-light border {{ explode(' ', $classes)[0] }}">
                                            <div class="info-box-content">
                                                ...
                                                <span
                                                    class="info-box-number text-center {{ explode(' ', $classes)[1] }} mb-0">
                                        ...
                                        <div class="info-box bg-light border border-info">
                                            <div class="info-box-content">
                                                ...
                                                @if ($cliente->contrato == null)
                                                    <span class="info-box-number text-center text-muted mb-0">Sin contrato
                                                        asignado</span>
                                                @else
                                                    <span
                                                        class="info-box-number text-center text-muted mb-0">{{ $cliente->contrato->plan->nombre }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="info-box bg-light border border-success">
                                            <div class="info-box-content">
                                                ...
                                                <span
                                                    class="info-box-number text-center text-muted mb-0">{{ $totalTicketsAbiertos }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="text-center py-3">
                                                    @if (!empty($inventario->modelo->foto) && file_exists(public_path('storage/' . $inventario->modelo->foto)))
                                                        <img src="{{ asset('storage/' . $inventario->modelo->foto) }}"
                                                            alt="Foto del modelo" class="img-fluid rounded shadow"
                                                ...
                                                @else
                                                    @if ($ticket->solucion == 'Se agendo visita')
                                                        <a href="{{ route('visitas.show', $ticket->visita->id) }}"
                                                            class="text-success" title="Ver visita">
                                                            {{ $ticket->solucion }}
                                                        </a>
                                                    @else
